...
class IssueTableMouseListener(MouseListener):
    ...
    def mouseClicked(self, event):
        if event.getClickCount() == 1:
            ...
            burpPanel.textName.text = rowData.get(1)
            burpPanel.textSeverity.text = rowData.get(2)
            burpPanel.textHost.text = rowData.get(3)
            burpPanel.textPath.text = rowData.get(4)
