...
// ShuffleOld, shuffles the order of questions in a non-cryptographically secure way.
// Based on https://www.calhoun.io/how-to-shuffle-arrays-and-slices-in-go/.
func (e *Exam) ShuffleOld() {
...
// Shuffle, shuffles the order of questions using rand.shuffle.
func (e *Exam) Shuffle() {
	rnd := rand.New(rand.NewSource(time.Now().Unix()))
